function go_to_player(url) {
   ...
   <span onclick="listPlayer('', 2);">
       <img src="https://od.lk/s/OTJfMjc0Nzc3ODlf"  >
   </span>
   <iframe sandbox="allow-same-origin allow-scripts" id="iframe" src="` + url + `" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>`;
